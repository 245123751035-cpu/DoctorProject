const en = {
  ...
  patient: {
    ...
    multiAgent: {
      title: "Multi-Agent Case Analysis",
      subtitle: "Run a coordinated multi-agent analysis using the latest consultation and the patient's stored history.",
      run: "Run Analysis",
      runAgain: "Run Again",
      running: "Running...",
      ...
      report: "Report Agent",
      symptomDone: "Extracted symptoms, duration, severity and chief complaint.",
      historyDone: "Analyzed previous consultations and medical history.",
      languageDone: "Processed the consultation language and preserved the original text.",
      reportDone: "Combined all agent outputs into the final structured clinical report.",
      fallback: "Offline mode",
      fallbackHint: "External AI is not configured — results were assembled from the structured patient records.",
      reportTitle: "Final Clinical Report",
      consultationLabel: "Analyzed consultation",
      chiefComplaint: "Chief Complaint",
      symptoms: "Symptoms",
      duration: "Duration",
      severity: "Severity",
      ...
      originalText: "Original text (preserved)",
      normalizedText: "Normalized text",
      noText: "No patient text recorded for this consultation.",
      currentSymptoms: "Current Symptoms",
      durationSeverity: "Duration and Severity",
      ...
      error: "Unable to run the multi-agent analysis right now. Your patient's stored records are still available."
    },
    symptoms: {
